...
- Next, download the HPO Aware Pretrain first, then choose either PhenoGPT2-Short-LoRA or PhenoGPT2-EHR-LoRA for the inference.
...
| PhenoGPT2-Short-LoRA | Text | LLaMA 3.1 8B | [Not release yet]() |
| PhenoGPT2-EHR-LoRA (main) | Text | LLaMA 3.1 8B | [Not release yet]() |
